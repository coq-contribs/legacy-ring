...
(*  List.fold_right SectionPathSet.add *)
  ...
  in
  List.map transform
    [ "LegacyRing.Ring_normalize.interp_cs";
      "LegacyRing.Ring_normalize.interp_var";
      "LegacyRing.Ring_normalize.interp_vl";
      "LegacyRing.Ring_abstract.interp_acs";
      "LegacyRing.Ring_abstract.interp_sacs";
      "Coq.quote.Quote.varmap_find";
      (* anciennement des Local devenus Definition *)
      "LegacyRing.Ring_normalize.ics_aux";
      "LegacyRing.Ring_normalize.ivl_aux";
      "LegacyRing.Ring_normalize.interp_m";
      "LegacyRing.Ring_abstract.iacs_aux";
      "LegacyRing.Ring_abstract.isacs_aux";
      "LegacyRing.Setoid_ring_normalize.interp_cs";
      "LegacyRing.Setoid_ring_normalize.interp_var";
      "LegacyRing.Setoid_ring_normalize.interp_vl";
      "LegacyRing.Setoid_ring_normalize.ics_aux";
      "LegacyRing.Setoid_ring_normalize.ivl_aux";
      "LegacyRing.Setoid_ring_normalize.interp_m";
    ]
...
let polynom_unfold_tac =
  let flags =
    (mkflags(fBETA::fMATCH::fFIX::fCOFIX::(List.map fCONST constants_to_unfold))) in
  reduct_in_concl (cbv_norm_flags flags,DEFAULTcast)

let polynom_unfold_tac_in_term gl =
  let flags =
    (mkflags(fBETA::fMATCH::fFIX::fCOFIX::fZETA::(List.map fCONST constants_to_unfold)))
  in
...
let polynom lc gl =
  Coqlib.check_required_library ["LegacyRing";"LegacyRing"];
  match lc with
